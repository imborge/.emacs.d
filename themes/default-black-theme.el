...
(custom-theme-set-faces
 'default-black
 '(default ((t (:inherit nil :stipple "Black" :background "Black" :foreground "White" :inverse-video nil :box nil :strike-t*hrough nil :overline nil :underline nil :slant normal :weight normal :width normal :height 105))))
